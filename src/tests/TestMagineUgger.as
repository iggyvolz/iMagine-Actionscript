package tests
{
  ...
  public class TestMagineUgger extends TestCase
  {
    ...
    {
      var array1:Array=[">edyn.magine(ugger)",Texts.I_MAGINE_SUCCESS.replace("%1","Ugger"),Texts.UGGER_CATCH_PHRASE,Subjects.SUBJECT_NAMES[0].ucfirst()+" lost 100 energy!  He now has 900 energy!"];
