package tests
{
  ...
  public class TestMagineFoamotos extends TestCase
  {
    ...
    {
      var array1:Array=[">strag.magine(foamotos)",Texts.I_MAGINE_SUCCESS.replace("%1","Foamotos"),Texts.FOAMOTOS_CATCH_PHRASE,Subjects.SUBJECT_NAMES[0].ucfirst()+" lost 100 energy!  He now has 900 energy!"];
