package tests
{
  ...
  public class TestMagineRiverAbaquist extends TestCase
  {
    ...
    {
      var array1:Array=[">tony.magine(riverabaquist)",Texts.I_MAGINE_SUCCESS.replace("%1","RiverAbaquist"),Texts.RIVER_ABAQUIST_CATCH_PHRASE,Subjects.SUBJECT_NAMES[0].ucfirst()+" lost 100 energy!  He now has 900 energy!"];
