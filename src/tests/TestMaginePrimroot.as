package tests
{
  ...
  public class TestMaginePrimroot extends TestCase
  {
    ...
    {
      var array1:Array=[">strag.magine(primroot)",Texts.I_MAGINE_SUCCESS.replace("%1","Primroot"),Texts.PRIMROOT_CATCH_PHRASE,Subjects.SUBJECT_NAMES[0].ucfirst()+" lost 100 energy!  He now has 900 energy!"];
