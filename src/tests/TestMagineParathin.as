package tests
{
  ...
  public class TestMagineParathin extends TestCase
  {
    ...
    {
      var array1:Array=[">tony.magine(parathin)",Texts.I_MAGINE_SUCCESS.replace("%1","Parathin"),Texts.PARATHIN_CATCH_PHRASE,Subjects.SUBJECT_NAMES[0].ucfirst()+" lost 100 energy!  He now has 900 energy!"];
